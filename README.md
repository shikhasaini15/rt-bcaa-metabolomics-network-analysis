...
Pathway enrichment via MetaboAnalyst Mummichog.

Network construction in Cytoscape using the MetScape plugin to link metabolites, genes, reactions, and enzymes.
...
BCAA metabolites showed tight co-regulation and increased hub connectivity in mitochondrial oxidation pathways.
